...
from model.resnet import ResNet50v1,ResNet101v2,ordinal_loss
...
def train_model(train_data, train_csv, test_data, test_csv, model_in,callbacks):
    ...
    # todo : remove loading of resnet if you want saved moel
    model = ResNet101v2()
    ...
    try:
        ...
        fl_weighted = f1_score(val_trues, val_pred)
