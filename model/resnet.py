...
def ResNet50v1():
  ...
  ("[INFO] Extracting ResNet50v1 model...")
  return model
...
def ResNet101v2():
  ...
  base_model = ResNet101V2(include_top=False, weights=weights, input_shape=(128, 128, 3))
  ...
  output = Dense(4,
                  activation='softmax',
                  kernel_initializer='he_normal')(base_resnet)
  
  model = Model(inputs=inputs, outputs=output)
  ("[INFO] Extracting ResNet101v2 model...")
  return model
